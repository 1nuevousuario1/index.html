    ...
    <div data-testid="home-page">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 md:py-32 text-center">
          <div className="inline-flex items-center gap-2 bg-[#FFD93D]/90 text-[#1F2937] px-4 py-1.5 rounded-full font-fredoka text-sm mb-6">
            <Sparkles size={16} /> Nueva colección 2026
          </div>
          <h1 className="font-fredoka text-4xl sm:text-5xl lg:text-6xl font-bold text-white drop-shadow-lg max-w-3xl mx-auto leading-tight">
            Encuentra los mejores juguetes para todas las edades
          </h1>
          <p className="mt-5 text-lg text-white/95 font-nunito max-w-xl mx-auto">
